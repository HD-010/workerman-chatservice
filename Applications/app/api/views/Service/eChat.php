...
<div id='eChatBox' style='width:100%;height:100%;position:fixed;top:0;background-color:white;display:none;'>
    ...
    <!-- 这里是聊天页面头部 -->
    	...
    	<ul id='chatfoot' style='border:0;border-top:1px solid #D5D5D5;width:100%;height:7.5%;background-color:#F9F9F9;font-size:150%'>
    		...
    		<li style='width:55%;float:right;margin-top:0.8em;height:2em;line-height:2em;'><a name="goback" href='#' style='border:1px solid #CCC; color:currentColor;padding:0.15em;'><<返回</a></li>
    	</ul>
